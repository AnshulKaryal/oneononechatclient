...
const SideDrawer = () => {
  ...
  const handleSearch = async (search) => {
    ...
    try {
      ...
      const { data } = await axios.get(`https://oneononechatserver.onrender.com/api/user?search=${search}`, config);
  ...
  const accessChat = async (userId) => {
    ...
    try {
      ...
      const { data } = await axios.post(`https://oneononechatserver.onrender.com/api/chat`, { userId }, config);
